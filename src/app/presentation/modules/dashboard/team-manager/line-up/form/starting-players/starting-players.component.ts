...
export class StartingPlayersComponent implements OnInit {
  ...
  filterPlayer(playing_position: any){
    ...
    this.playerNameList = this.playerList.filter((x: any) => x.playing_position == playing_position);
  }
  ...
  mapPlayerPlayerTen(name: any){
    const player = this.playerNameList.find((x: any) => x.first_name == name);
    this.teamEventHelper.teamPlayingXI.first_name_P10 = player?.first_name;
    this.teamEventHelper.teamPlayingXI.jersey_number_P10 = player?.jersey_number
    this.teamEventHelper.teamPlayingXI.fifa_id_P10 = player?.fifa_id
    this.teamEventHelper.teamPlayingXI.signature_P10 = player?.signature
    this.teamEventHelper.teamPlayingXI.player_image_P10 = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7rAXspe1a2jEJ0Ml5kaRrz0SUQsyJv2vHSFbzHXxeVw&s'
  }

  mapPlayerPlayerEleven(name: any){
    const player = this.playerNameList.find((x: any) => x.first_name == name);
    this.teamEventHelper.teamPlayingXI.first_name_P11 = player?.first_name;
    this.teamEventHelper.teamPlayingXI.jersey_number_P11 = player?.jersey_number
    this.teamEventHelper.teamPlayingXI.fifa_id_P11 = player?.fifa_id
    this.teamEventHelper.teamPlayingXI.signature_P11 = player?.signature
    this.teamEventHelper.teamPlayingXI.player_image_P11 = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7rAXspe1a2jEJ0Ml5kaRrz0SUQsyJv2vHSFbzHXxeVw&s'
  }
}
