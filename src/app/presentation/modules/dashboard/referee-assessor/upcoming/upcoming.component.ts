...
export class RefereeAssessorUpcomingComponent implements OnInit {
  ...
  handleView(e: any) {
    this.router.navigate(["/dashboard/r/referee-assessor/form/details"], { queryParams: { id: e.number } });
  }

  handleUpload(e: any) {
    this.router.navigate(["/dashboard/r/referee-assessor/form/upload"], { queryParams: { id: e.number } });
  }
}
